import {
  ...
  export default class Login {
    ...
    constructor() {
      ...
      this.$goToRegister = document.createElement("button");
      this.$goToRegister.type = 'button';
      this.$goToRegister.textContent = "Create an account";
      this.$goToRegister.setAttribute("class", "bg-white font-bold py-2 px-4 rounded-md");
