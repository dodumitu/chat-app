import {
  ...
  class Register {
    ...
    constructor() {
      ...
      this.$goToLoginPage = document.createElement("button");
      this.$goToLoginPage.type = 'button'
      this.$goToLoginPage.textContent = "Already have an account";
      this.$goToLoginPage.setAttribute("class", "bg-white font-bold py-2 px-4 rounded-md");
